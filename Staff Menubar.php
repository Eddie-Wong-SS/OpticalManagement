<?php
/** Menubar for the usage of the staff */
session_start();
?>
    ...
    font-size: 16px;"> Main Menu </a> </div></td>
            <td class="paddy"><div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="viewPatient.php?id=A">Add Patient Account</a>
                        <a href="viewAcc.php?Id=V&type=M">View Patient Accounts</a>
                    </div>
                </div></td>
            ...
            <td class="paddy"><div class="dropdown"><button class="dropbtn">Report &#9660</button>
                    <div class="dropdown-content">
                        ...
                        <a href="viewSales.php?type=R&id=<?php echo $_SESSION['Username'] ?>">Personal Sales Report</a>
                        <a href="viewPayment.php">Payment Report</a>
                        <a href="viewPayment.php?id=<?php echo $_SESSION['Username'] ?>">Collected Payment Report</a>
            ...
            <td class="paddy"><div class="dropdown"><button class="dropbtn"> <?php echo $_SESSION['Username']."&#9660"; ?> </button>
                    <div class="dropdown-content">
                        <a href="editStaff.php?Id=<?php echo $_SESSION['IC']; ?>">Profile</a>
