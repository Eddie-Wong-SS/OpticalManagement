<?php
/**
 Allows the creation of a frame record in the inventory
 */
...
if($_REQUEST['btnSub'])
{
    ...
    else
    {
        ...
        else
        {
            ...
            $lSQL = "INSERT INTO tblframes(frameCode, frameMaterial, Color, Shape, Hinge) VALUES(
                    '" . strtoupper(trim($_POST['iCode'])) . "',
                    '" . strtoupper(trim($_POST['fMat'])) . "',
                    '" . strtoupper(trim($_POST['fColor'])) . "',
                    '" . strtoupper(trim($_POST['fShape'])) . "',
                    '" . strtoupper(trim($_POST['fHinge'])) . "')";
    ...
    <form method="post" action="" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="iCode" id="iCode" maxlength="25" size="27" placeholder="F01" required> </td>
            ...
            <tr>
                ...
                <td><input type="text" name="iType" id="iType" value="Frame" size="7" style="background-color: lightgray" readonly> </td>
            </tr>
        </table>
        <br/>
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="fMat" id="fMat" maxlength="25" size="27" required> </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="fShape" id="fShape" size="12" maxlength="10" required> </td>
            </tr>
            <tr>
                <td class="move"><label for="fHinge">*Hinge: </label></td>
                <td><input type="text" name="fHinge" id="fHinge" size="22" maxlength="20" required></td>
            </tr>
        </table>
       <br/>
        <table>
