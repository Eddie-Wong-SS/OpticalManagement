<?php
/**
 *Adds a contact lens to the cart
 */
error_reporting(1);
session_start();
...
<title>Add Contacts to Cart</title>
<link rel="stylesheet" type = "text/css" href="Default%20Theme.css" />

<?php
if($_REQUEST['btnSub'])
{
    $SQL = "SELECT * FROM tblinventory, tblcontacts, tblsellprice, tblcurrentstock WHERE 
            tblinventory.Code = tblcontacts.contactCode AND tblinventory.ItemId = tblsellprice.ItemId AND tblcurrentstock.ItemId = tblinventory.ItemId
             AND Code = '".$_GET['Id']."'";
    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $Row['conMaterial'] ?></td>
            </tr>
            <tr>
                <td class="move"><label for="cColor">*Contact Color: </label></td>
                <td><?php echo $Row['conColor'] ?></td>
            </tr>
        </table>
        <br/>
        <table>
            ...
            <tr>
                ...
                <td><?php echo $Row['ExpireDateC'] ?></td>
            </tr>
        </table>
        <br />
        <table>
