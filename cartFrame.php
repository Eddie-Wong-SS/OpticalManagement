...
<title>Add Frames to Cart</title>
<link rel="stylesheet" type = "text/css" href="Default%20Theme.css" />

<?php
if($_REQUEST['btnSub'])
{
    $SQL = "SELECT * FROM tblinventory, tblframes, tblsellprice, tblcurrentstock WHERE 
            tblinventory.Code = tblframes.frameCode AND tblinventory.ItemId = tblsellprice.ItemId AND tblcurrentstock.ItemId = tblinventory.ItemId
             AND Code = '".$_GET['Id']."'";
    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $Row['frameMaterial'] ?></td>
            </tr>
            <tr>
