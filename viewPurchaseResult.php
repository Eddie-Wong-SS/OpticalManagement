...
<script>
    function printIt()
    {
        ...
        $('.Printing').printThis({
            ...
            pageTitle: "Purchases",              // add title to print page
...
<title>Purchases Search Result</title>
        ...
        if(mysqli_num_rows($Result) > 0)
        {
            ...
            <form method="post" action="">
                <?php if($maxPage > 1 && $page != $maxPage)
                    echo "<button><a style='font-size: 21px'  href='viewPurchaseResult.php?page=".($page+1)."'>&#62;</a> </button>"?> &nbsp;
                ...
                <table align="center">
                    ...
                    <tr>
                        <th scope="col">No</th>
                        <th scope="col">Purchase Form Code</th>
                    ...
                    for($i = $minLim ; $i <= $maxLim; ++$i)
                    {
                        ...
                        echo "<tr>";
                        echo "<td>".($i)."</td>";
                        echo "<td style='text-align: center'>".$RowInfo['purCode']."</td>";
                        ...
                        echo "<td style='text-align: center'>".$RowInfo['ItemDesc']."</td>";                   
